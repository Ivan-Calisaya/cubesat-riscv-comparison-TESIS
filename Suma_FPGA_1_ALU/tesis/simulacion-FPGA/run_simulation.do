...
# Señales de la ALU
add wave -label "ALU_A" -radix unsigned /simple_processor_tb/dut/dp/EXECUTE/alu/a
add wave -label "ALU_B" -radix unsigned /simple_processor_tb/dut/dp/EXECUTE/alu/b
add wave -label "ALU_Result" -radix unsigned /simple_processor_tb/dut/dp/EXECUTE/alu/result
