/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/__w/riscv-none-elf-gcc-xpack/riscv-none-elf-gcc-xpack/build-assets/build/win32-x64/sources/gcc-14.2.0/gcc/config/riscv/riscv.md'.  */
